...
public class ObjLoader implements StillModelLoader {
    ...
    public StillModel loadObj(FileHandle file, FileHandle textureDir, boolean flipV) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (tokens[0].length() == 0) {
                    ...
                    if (tokens[0].length() == 1) {
                        ...
                        uvs.add((flipV ? 1 - Float.parseFloat(tokens[2]) : Float
                                .parseFloat(tokens[2])));
                    }
                } else if (firstChar == 'f') {
                    String[] parts;
        ...
        for (int g = 0; g < numGroups; g++) {
            ...
            final float[] finalVerts = new float[(numFaces * 3)
            ...
            mesh = new Mesh(true, numFaces * 3, numIndices,
